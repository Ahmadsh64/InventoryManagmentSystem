...
INSERT INTO `employees` VALUES (1,'ahmad','shalata','sakhnin','0533071442','shalataahmad10@gmail.com','Ahmad11','ahmad11',50.00,1,'manager'),(2,'rymym','rym','rym','782','ghm','aa','1234',20.00,2,'worker'),(3,'guy','pery','zefat','0501234567','guypery@walla.co.il','guy12','guy1234',60.00,2,'manager');
...
CREATE TABLE `order_items` (
  ...
  KEY `fk_processed_employee` (`processed_by_employee_id`),
  CONSTRAINT `fk_order_items_sku` FOREIGN KEY (`sku`) REFERENCES `inventory` (`sku`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_processed_employee` FOREIGN KEY (`processed_by_employee_id`) REFERENCES `employees` (`employee_id`),
...
INSERT INTO `order_items` VALUES (1,110,'221','shirt',2,'Black','XL','סיום המכלה','2025-06-17 00:35:48',NULL),(2,111,'111','TTT',3,'Blue','XL','התחלת המכלה','2025-06-15 19:06:58',NULL),(3,111,'2121','sdsd',2,'yellow','S','חדש','2025-06-15 19:07:19',NULL);
...
INSERT INTO `order_notifications` VALUES (1,110,1,'2025-05-25 19:54:51','2025-06-17 00:36:03'),(2,111,0,'2025-05-27 20:02:31','2025-06-15 19:07:30');
...
-- Dump completed on 2025-06-23 22:04:55
